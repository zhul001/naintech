...
function CodeBox({ id, cmd, onCopy }: { id: string; cmd: string; onCopy: CopyFn }) {
  return (
...
export default function ProxyPage() {
  ...
  const copyToClipboard: CopyFn = (text, id) => {
      ...
      custom: (
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-sm text-zinc-500 mt-4">Isi dengan domain yang ingin diblokir (satu per baris, dengan titik di depan agar mencakup subdomain):</p>
  ...
  return (
    <div className="max-w-4xl mx-auto px-6" suppressHydrationWarning>
